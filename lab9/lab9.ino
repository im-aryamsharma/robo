...
void roaming()
{
  ...
  print("GYRO", "angle ", avg_angle);
  print("MOTOR", "left ", SPEED_NORMAL - avg_angle);
  print("MOTOR", "right", SPEED_NORMAL + avg_angle);

  move_motors(constrain(SPEED_NORMAL - avg_angle, 0, SPEED_MAX), constrain(SPEED_NORMAL + avg_angle, 0, SPEED_MAX));
